...
public class LoggingService {
    ...
    public static <T> ServiceFactory<?,Printer<T>> create(String logDir, FunctionEx<T, String> toStringFn){
        // the create function
    ...
    public static <T> StreamStage<T> log(StreamStage<T> stage, String logDir, FunctionEx<T, String> toStringFn){
        return stage.mapUsingService(
                LoggingService.create(logDir,toStringFn),
